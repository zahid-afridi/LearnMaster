...
export default function FeaturedCourses() {
  ...
  {
    course && console.log("courseMetafrom frontend", course);
  }
  ...
  const featuredCourses = [
    ...
    },
    {
      ...
      description:
        "Master camera settings, composition, lighting, and post-processing techniques.",
  ...
  return (
    <section className="py-16">
      <div className="container max-w-7xl mx-auto  px-4 sm:px-6">
        ...
        {/* Course Grid */}
        <div
          className="grid grid-cols-1 md:grid-cols-2 cursor-pointer lg:grid-cols-3 gap-8"
          onClick={HanldeCourseClick}
        >
          {course &&
            course.map((course) => (
              <div
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-4 left-4">
                    ...
                    >
                      {course.is_premium && <Award className="w-3 h-3 mr-1" />}
                      {course.level}
                    </span>
                  </div>
                  {/* Category Badge */}
