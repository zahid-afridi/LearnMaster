...
const Post = ({ post, handleBlog }) => (
    <article
        ...
        className="p-3 sm:p-4 cursor-pointer border-b border-gray-200 dark:border-[#2F3336] hover:bg-gray-50/50 dark:hover:bg-[#080808] transition-colors duration-200"
    >
